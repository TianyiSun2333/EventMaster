...
//     // redirectUri: 'http://www.example.com/recommnedation?name=abc'
// });
...
const SONGKICK_APIKEY = 'WHQKNB1MxE9W4jYi';
const GOOGLE_SEARCH_API_URL_PREFIX = 'https://www.googleapis.com';
const GOOGLE_MAP_API_URL_PREFIX = 'https://maps.googleapis.com';
const GOOGLE_APIKEY = 'AIzaSyCqfqVTo2vW9gZu6jF6yFMxza7OB610_g4';
const GOOGLE_SEARCHENGINE_ID = '013580047852591512301:kbc_qqskhhs';
const TICKETMASTER_APIKEY = '7NA73BmGGG82NmAWt30lJNIJxdMTmljv';
const TICKETMASTER_PREFIX = 'https://app.ticketmaster.com/discovery/v2';
const SPOTIFY_CLIENT_ID = 'e02ecd120cc1437c91cb34d31acfeebf';
const SPOTIFY_CLIENT_SECRET = '176f5a13cc7442589ca8b26a498bf109';
const CATEGORY = {
...
//                     res.end();
//                 case '/recommendation':
//                     recommendationHandler(res, query);
//
//                     console.log('get request for recommendation');
//                     break;
//                 case '/events':
//                     eventsHandler(res, query);
//
//                     break;
//                 case '/detail':
//                     detailHandler(res, query);
//
//                     break;
//                 case '/artist':
//                     artistHandler(res, query);
//
//                     break;
//                 case '/venue':
//                     venueHandler(res, query);
//
//                     break;
//                 case '/upcomingevents':
//                     upComingEventsHandler(res, query);
// //
//                     break;
//                 case '/images':
//                     imagesHandler(res, query);
//
//                     break;
//                 default:
//                     res.writeHead(200);
